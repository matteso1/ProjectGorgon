...
## Architecture: Medusa Draft Heads
...
A natural first attempt is simple:

```
hidden_state -> Linear(4096, 4096) -> SiLU -> + skip -> Linear(4096, vocab) -> logits
```
...
```
      ...
      /|\\ /|\\ /|\\ /|\\
     h2  h2  h2  h2          (4 x 4 = 16 from head 2)
     ...
```
